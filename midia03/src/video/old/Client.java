...
public class Client{
  ...
  public void start() throws Exception
  {
    ...
    InetAddress ServerIPAddr = InetAddress.getByName(ip);
  ...
  private void send_RTSP_request(String request_type)
  {
    try{
      ...
      RTSPBufferedWriter.write(request_type + " " + VideoFileName + " RTSP/1.0" + CRLF); //C: SETUP movie.Mjpeg RTSP/1.0

      //write the CSeq line:
      RTSPBufferedWriter.write("CSeq: " + RTSPSeqNb + CRLF); //CSeq: 1
