...
public class ServerVideo extends JFrame implements ActionListener {
	...
	public static int getRtspPortUsed() {
		return rtspPortUsed;
	}
	...
	public static int mainMethod(int RTSPport) throws IOException, Exception,
	SocketException {
		File file = new File("movie.Mjpeg");
		//	  System.out.println(file.getAbsolutePath()+" exists "+file.exists());
		//create a Server object
		final ServerVideo theServer = new ServerVideo();
